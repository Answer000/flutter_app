...
loginDataFromJson(LoginData data, Map<String, dynamic> json) {
	if (json['tokenExpiryDate'] != null) {
		data.tokenExpiryDate = json['tokenExpiryDate'] is String
				? int.tryParse(json['tokenExpiryDate'])
				: json['tokenExpiryDate'].toInt();
	}
	if (json['isFirstLogin'] != null) {
		data.isFirstLogin = json['isFirstLogin'].toString();
	}
	if (json['systemDate'] != null) {
		data.systemDate = json['systemDate'] is String
				? int.tryParse(json['systemDate'])
				: json['systemDate'].toInt();
	}
	if (json['userId'] != null) {
