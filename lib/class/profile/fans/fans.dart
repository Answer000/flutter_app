...
import 'package:flutter_app/class/profile/fans/fansViewModel.dart';
...
class Fans extends BaseContainer {
...
class FansState extends BaseContainerState<Fans> {

  ScrollController _scrollController = ScrollController();

  FansViewModel _viewModel = FansViewModel();

  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    this.navigationBar.title = "粉丝";
        ...
        children: [
          ...
          Container(
            ...
            child: this._viewModel.lists[index].pastContent.setRichText(
                ...
                "  ${this._viewModel.dataEntity.total ?? 0}个  ",
                TextStyle(
